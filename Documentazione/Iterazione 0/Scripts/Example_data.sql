INSERT INTO aat (id, nome, latitudine, longitudine) VALUES
...
INSERT INTO operatore118 (user, pwd, nome, cognome) VALUES
...
INSERT INTO ospedale (id, nome, latitudine, longitudine, disp) VALUES
...
INSERT INTO mezzo (id, targa, tipo, stato, idAATM) VALUES
...
INSERT INTO squadra (id, stato_attuale, disp, idMezzo, idAATS) VALUES
(1,'IN SEDE',0,1,1),
(2,'IN SEDE',0,2,1),
(3,'SUL POSTO',1,3,2),
...
INSERT INTO volontario (id, nome, cognome, user, pwd, idSquadraV) VALUES
...
INSERT INTO emergenza (numero_missione, latitudine, longitudine, data, orario, motivo, codGravita, idOp118, idOspedale, idSquadraE) VALUES
...
INSERT INTO paziente (id,nome,cognome,eta,sesso,cosciente,respira,patologie,idEmergenza) VALUES
